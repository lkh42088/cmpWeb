...
export default class AlertComponent extends PureComponent {
    ...
    render() {
        ...
        if (visible) {
            return (
                <Col md={md} lg={lg} xl={xl} sm={sm} xs={xs} style={{padding: "10px 10px"}}>
                    <Card
                        className={`panel${color ? ` panel--${color}` : ''}
            ${divider ? ' panel--divider' : ''}${collapse ? '' : ' panel--collapse'} ${panelClass} cb-card`}
                    >
                        <CardBody className="panel__body">
                            ...
                            <div className="panel__btns">
                                ...
                                <button className="panel__btn" type="button" onClick={close}><CloseIcon /></button>
                            </div>
