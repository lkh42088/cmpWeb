...
import MonitoringModalList from './MonitoringModalList';

class MonitoringModal extends PureComponent {
    static propTypes = {
    ...
    render() {
        ...
        switch (modalType) {
            ...
            case 'view':
                ...
                break;
            case 'edit':
                modalContent = <MonitoringModalList closeToggle={this.toggle} title={title} message={message}/>;
                break;
            default:
                modalContent = 'Error!';
                break;
