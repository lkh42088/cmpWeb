    ...
    render() {
        ...
        return (
            <Col md={12} lg={12}>
                ...
                <div style={nbBtnWidth}>
                    <div className="float-right">
                        <Link className="btn btn-primary products-list__btn-add" to="/assets/write">장비반출</Link>
                        <Link className="btn btn-primary products-list__btn-add" to="/assets/write">장비등록</Link>
                    </div>
